    ...
    const fetchProducts = async () => {
      try {
        ...
        if (response.ok) {
          ...
          const macbookIds = [17, 16, 15, 5, 3, 31, 32, 33];
          const macbookProducts = data
            .filter((product: Product) => macbookIds.includes(product.id))
            .sort((a: Product, b: Product) => 
              macbookIds.indexOf(a.id) - macbookIds.indexOf(b.id)
            );
          
          const accessoryIds = [35, 36, 37, 38];
          const accessoryProducts = data
            .filter((product: Product) => accessoryIds.includes(product.id))
            .sort((a: Product, b: Product) => 
              accessoryIds.indexOf(a.id) - accessoryIds.indexOf(b.id)
            );
  ...
  return (
    <>
      <div className="hidden lg:block">
        ...
        >
          <motion.h1 
            className="text-6xl font-semibold bg-gradient-to-r from-purple-400 to-orange-500 bg-clip-text text-transparent -mt-9"
            initial={{ opacity: 0, y: -30 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        >
            ...
            >
              {macbooks.map((product) => (
                ...
                >
                  ...
                  >
                    <img
                      src={product.imagem_url || "https://via.placeholder.com/400x300?text=MacBook"}
                      alt={product.nome}
                      className="w-full h-48 object-cover"
                      onError={(e) => {
                        e.currentTarget.src = "https://via.placeholder.com/400x300?text=MacBook";
                      }}
                    />
          ...
          >
            <div className="grid grid-cols-2 gap-9 -mx-9">
              ...
              >
                <h1 className="text-3xl font-semibold mb-4">Magic Mouse</h1>
                <p className="text-gray-700 text-2xl mb-8 -mx-1">
                  O Magic Mouse oferece controle Multi-Touch intuitivo com gestos simples para navegar no conteúdo digital.
                </p>
                <img
                  src="https://store.storeimages.cdn-apple.com/4982/as-images.apple.com/is/MK2E3?wid=1144&hei=1144&fmt=jpeg&qlt=90&.v=1626468075000"
              ...
              >
                <h1 className="text-4xl font-semibold mb-4">Acessórios para MacBook</h1>
                <p className="text-gray-700 text-2xl mb-7 -mx-1">
                  Descubra adaptadores, hubs USB-C, teclados Magic Keyboard, trackpads e muito mais para seu MacBook.
                </p>
                <img
                  src="https://store.storeimages.cdn-apple.com/4982/as-images.apple.com/is/MUF82?wid=1144&hei=1144&fmt=jpeg&qlt=90&.v=1540596033000"
                  className="rounded-lg w-full"
                  alt="Acessórios MacBook"
                />
              </motion.div>
            </div>
          </motion.section>
          ...
          >
            <h1 className="text-3xl font-semibold text-gray-600">
              Acessórios que transformam seu MacBook em ainda mais poder e estilo.
            </h1>
          </motion.section>
      ...
      <div className="block lg:hidden">
        <div className="min-h-screen bg-white">
          ...
          >
            <motion.h1 
              className="text-3xl sm:text-4xl font-semibold bg-gradient-to-r from-purple-400 to-orange-500 bg-clip-text text-transparent mb-2"
            ...
            >
              {macbooks.map((product) => (
                ...
                >
                  ...
                  >
                    <img
                      src={product.imagem_url || "https://via.placeholder.com/300x200?text=MacBook"}
                      alt={product.nome}
                      className="w-full h-32 sm:h-40 object-cover"
                      onError={(e) => {
                        e.currentTarget.src = "https://via.placeholder.com/300x200?text=MacBook";
                      }}
                    />
          ...
          >
            ...
            >
              <h2 className="text-2xl font-semibold mb-3">Magic Mouse</h2>
