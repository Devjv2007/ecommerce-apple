    ...
    const fetchProducts = async () => {
      try {
        ...
        if (response.ok) {
          ...
          const iphoneIds = [66, 65, 64, 63, 62, 61, 60, 59];
  ...
  return (
    <>
      <div className="hidden lg:block">
        ...
        >
          <motion.img 
            src="https://www.apple.com/in/watch/images/meta/apple-watch__beyyf7scxu1u_og.png?202508061958"
            alt="Apple Watch"
                ...
                >
                  ...
                  >
                    <div className="h-80 bg-gray-50 flex items-center justify-center p-4">
                      <img
                        src={product.imagem_url || "https://via.placeholder.com/400x300?text=Watch"}
                        alt={product.nome}
                        className="max-h-full max-w-full object-contain"
                        onError={(e) => {
                          e.currentTarget.src = "https://via.placeholder.com/400x300?text=Watch";
                        }}
                      />
                    </div>
          ...
          >
            <div className="grid grid-cols-2 gap-9 -mx-9">
              ...
              >
                <h1 className="text-3xl font-semibold mb-4">Saúde dia e noite.</h1>
                <p className="text-gray-700 text-2xl mb-8 -mx-1">
                 Insights sobre sua saúde
                </p>
                <img
                  src="https://www.apple.com/newsroom/images/2024/06/watchos-11-brings-powerful-health-and-fitness-insights/article/Apple-WWDC24-watchOS-11-Apple-Watch-3-up-240610_big.jpg.large.jpg"
              ...
              >
                <h1 className="text-4xl font-semibold mb-4">Mantenha-se alertado</h1>
                <p className="text-gray-700 text-2xl mb-7 -mx-1">
                 Seu Watch conectado com o Mundo 
                </p>
                <img
                  src="https://olhardigital.com.br/wp-content/uploads/2023/08/capa-2-695x500.png"
                  className="rounded-lg w-full"
                  alt="Segurança"
                />
              </motion.div>
          ...
          >
            <h1 className="text-3xl font-semibold text-gray-600">
              Acessórios para seu Apple Watch.
            </h1>
          </motion.section>
      ...
      <div className="block lg:hidden">
        <div className="min-h-screen bg-white">
                ...
                >
                  ...
                  >
                    <div className="h-64 sm:h-80 bg-gray-50 flex items-center justify-center p-3">
                      <img
                        src={product.imagem_url || "https://via.placeholder.com/300x200?text=Watch"}
                        alt={product.nome}
                        className="max-h-full max-w-full object-contain"
                        onError={(e) => {
                          e.currentTarget.src = "https://via.placeholder.com/300x200?text=Watch";
                        }}
                      />
                    </div>
          ...
          >
            ...
            >
              <h2 className="text-2xl font-semibold mb-3">Saúde dia e noite.</h2>
