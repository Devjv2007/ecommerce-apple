  ...
  return (
    <>
      <div className="hidden lg:block">
        ...
        >
          <motion.h1 
            className="text-6xl font-semibold bg-gradient-to-r from-gray-400 to-black bg-clip-text text-transparent -mt-9"
            initial={{ opacity: 0, y: -30 }}
            animate={{ opacity: 1, y: 0 }}
      ...
      <div className="block lg:hidden">
        <div className="min-h-screen bg-white">
          ...
          >
            <motion.h1 
              className="text-3xl sm:text-4xl font-semibold bg-gradient-to-r from-gray-200 to-black bg-clip-text text-transparent mb-2"
